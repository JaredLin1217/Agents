...
| `docs/agents/*.yaml` | Canonical governance, deployment, verification, schema, MCP, and version rules. |
...
4. `docs/agents/verify.yaml` before claims, commits, deployments, or releases
5. `docs/agents/deploy.yaml` before deploying into another repository
...
Current Agents workflow version: `2.0.0` (`v2`).
