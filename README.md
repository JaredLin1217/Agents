...
Current Agents workflow version: `2.2.0` (`v2`).
...
- `.agents/runtime/`, `.agents/runtime/workflows/`, `.workflow/`, `.codex/`,
  status records, evidence records, secrets, and local environment state are not
