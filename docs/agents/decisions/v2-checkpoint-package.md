...
This package turns the v2 initial structure work into a reviewable checkpoint.
It is not a release, deployment, tag, push, or runtime behavior claim.
...
| Fixtures | `tests/agents-policy-fixtures/` | Prove passing and failing schema-contract cases. |
