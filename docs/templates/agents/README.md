...
- `agent-*.template.md`, `controller-lease.template.md`, `hard-isolation-evidence.template.md`: runtime and evidence schemas.
- `codex-memory.md`, `project-memory.md`, `memory-index.md`, `memory-entries-README.md`: target-local memory starters.
