...
- Close/cleanup: Runtime close attempted | Runtime close result | History cleanup requested | History cleanup authorization | History cleanup target ids | History cleanup DB | History cleanup result
