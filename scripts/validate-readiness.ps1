...
@("docs/agents/version.yaml", "precision-efficiency"),
...
@("docs/agents/openai-foundations.yaml", "progressive_disclosure"),
@("docs/agents/openai-foundations.yaml", "one_state_owner"),
@("docs/agents/openai-foundations.yaml", "codex_memories"),
@("docs/agents/openai-foundations.yaml", "compaction"),
@("docs/agents/openai-foundations.yaml", "token_counting"),
@("scripts/validate-foundation.ps1", "Test-FoundationCreationIntegrity"),
@("docs/agents/verify.yaml", "change_aware:"),
@("docs/agents/verify.yaml", "knowledge_footprint:"),
